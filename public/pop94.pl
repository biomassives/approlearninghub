...
# Base directory to create the folders
my $base_dir = "./modules";

# Create base modules directory
if (!-d $base_dir) {
    make_path($base_dir) or die "Cannot create $base_dir: $!";
    print "Created base directory: $base_dir\n";
}

# Create header.js file
my $header_file = "$base_dir/header.js";
open(my $header_fh, '>', $header_file) or die "Cannot create $header_file: $!";
print $header_fh "// Header module\n";
print $header_fh "document.write('<header><h1>Environmental and Technical Training Modules</h1></header>');\n";
close($header_fh);
print "Created header file: $header_file\n";

# Hard-coded paths from the HTML - no need to read from paste.txt
my @paths = (
    "modules/water-distribution",
    "modules/water-distribution/plumbing",
    "modules/water-distribution/piping",
    "modules/water-distribution/water-quality",
    "modules/water-distribution/community-water",
    
    "modules/solar-energy",
    "modules/solar-energy/installation",
    "modules/solar-energy/design",
    "modules/solar-energy/off-grid",
    "modules/solar-energy/troubleshooting",
    
    "modules/water-purification",
    "modules/water-purification/filtration",
    "modules/water-purification/disinfection",
    "modules/water-purification/rainwater",
    "modules/water-purification/diy-filters",
    
    "modules/waste-management",
    "modules/waste-management/reduction",
    "modules/waste-management/composting",
    "modules/waste-management/wastewater",
    "modules/waste-management/community",
    
    "modules/arduino",
    "modules/arduino/intro",
    "modules/arduino/sensors",
    "modules/arduino/data-logging",
    "modules/arduino/remote-monitoring",
    
    "modules/pump-repair",
    "modules/pump-repair/types",
    "modules/pump-repair/troubleshooting",
    "modules/pump-repair/techniques",
    "modules/pump-repair/preventive",
    
    "modules/energy-storage",
    "modules/energy-storage/types",
    "modules/energy-storage/safety",
    "modules/energy-storage/charging",
    "modules/energy-storage/maintenance",
    
    "modules/skill-training",
    "modules/skill-training/exams",
    "modules/skill-training/materials",
    "modules/skill-training/community",
    
    "modules/vocational-skill-training",
    "modules/vocational-skill-training/concrete",
    "modules/vocational-skill-training/diesel-mechanics",
    "modules/vocational-skill-training/electrical",
    "modules/vocational-skill-training/plumbing",
    "modules/vocational-skill-training/hvac",
    "modules/vocational-skill-training/auto-mechanics",
    "modules/vocational-skill-training/carpentry",
    "modules/vocational-skill-training/bicycle-repair",
    "modules/vocational-skill-training/food-prep",
    
    "modules/circular-economy",
    "modules/circular-economy/scrap-metal",
    "modules/circular-economy/plastic",
    "modules/circular-economy/compost",
    "modules/circular-economy/waste-hazard-and-opportunity-mapping"
);
...
foreach my $path (@paths) {
    ...
    if (!-d $path) {
        ...
        if ($@) {
            warn "Error creating directory $path: $@\n";
            next;
        }
    }
    
    # Create index.html file
    my $index_file = "$path/index.html";
    
    eval {
        # Extract module/submodule name from path for title
        my $name = $path;
        $name =~ s/^modules\///;
        $name =~ s/\//-/g;
        $name =~ s/-/ /g;
        ...
        # Extract module name for data attribute
        my $module_name = $path;

        # Create the HTML file
        open(my $html_fh, '>', $index_file) or die "Cannot create $index_file: $!";
                    ...
                    <div id="auth-top-right" class="flex items-center space-x-4">
                        <div id="auth-logged-out-top-right">
                            ...
                            <select id="sort-milestones">
                                ...
                                <div id="milestones-list" data-module="$module_name"></div>

                                <template id="milestone-template">
                                    <div class="milestone-item" data-module="$module_name">
...
HTML
 ...
 close($html_fh);
    ...
    if ($@) {
        warn "Error creating $index_file: $@\n";
    }
}

print "\nSuccessfully created $count directories and HTML files.\n";
print "To add database functionality, update the script with your database connection details.\n";
